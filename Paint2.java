...
public class Paint2 {
    ...
    public static void main(String[] args) {
        ...
        //ceil(double a) Returns the smallest (closest to negative infinity) double value that is 
        //greater than or equal to the argument and is equal to a mathematical integer.
        cansNeeded = Math.ceil(gallonsPaintNeeded);
        System.out.println("Cans needed: " + cansNeeded + " can(s)" );//Prints the number of cans needed
    }
}
